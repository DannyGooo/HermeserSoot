  ...
  protected void internalTransform(String phaseName, Map<String, String> options) {
    ...
    while (it.hasNext()) {
      ...
      while (methodIterator.hasNext()) {
        ...
        if (subSig.equals(
            Options.v().src_prec() == Options.src_prec_dotnet ? (DotnetMethod.MAIN_METHOD_SIGNATURE) : 
              (Options.v().src_prec() == Options.src_prec_hbc ? HbcMethod.MAIN_METHOD_SIGNATURE:
            JavaMethods.SIG_MAIN))
