...
public class ReactUtil {
    ...
    protected static Boolean isReactModulesDetected = false;
    ...
    public static ArrayList<SootClass> reactNewModulesList;
    public static ArrayList<SootClass> reactOldModulesList;
    ...
    public static void clearReactUtil(){
        ...
        reactNewModulesList = null;
        reactOldModulesList = null;
    }
    ...
    public static void constructModulesAPIMap(){
        for(SootClass reactModule: reactModules.keySet()){
            ...
            SootMethod getNameMethod = reactModule.getMethodByName("getName");
    ...
    public static Map<SootClass, Collection<SootMethod>> extractReactModules(){
        ...
        reactOldModulesList = new ArrayList<>(reactOldArchModuleClasses);
        reactNewModulesList = new ArrayList<>(reactNewArchModuleClasses);
