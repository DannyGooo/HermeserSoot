...
public class PackManager {
  ...
  public void writeOutput() {
    System.out.println("[PackManager] [writeOutput]");
    setupJAR();
    ...
    switch (Options.v().output_format()) {
      ...
      case Options.output_format_force_dex:
        ...
        break;
      default:
        System.out.println("[PackManager] [writeOutput] goWriteOutput");        
  ...
  protected void writeOutput(Iterator<SootClass> classes) {
    ...
    System.out.println("[PacjManager] [writeOutput] <Iterator>");
    ...
    System.out.println("[PacjManager] [writeOutput] <Iterator> classes.hasNext() " + classes.hasNext());
    while (classes.hasNext()) {
      final SootClass c = classes.next();
