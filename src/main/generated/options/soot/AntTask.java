...
public class AntTask extends MatchingTask {
    ...
    public void execute() throws BuildException {
        ...
        public void setreact_native(boolean arg) {
            if(arg) addArg("-react-native");
        }
  
        public void sethbc_control_flow_sensitive(boolean arg) {
            if(arg) addArg("-hbc-control-flow-sensitive");
        }
        ...
        public void sethbc_nativehost_path(String arg) {
            addArg("-hbc-nativehost-path");
            addArg(arg);
        }
        ...
        public void setresolve_all_hbc_methods(boolean arg) {
            if(arg) addArg("-resolve-all-hbc-methods");
        }
