...
public class Options extends OptionsBase {
    ...
    public static final int src_prec_hbc = 8;
    ...
    public static final int throw_analysis_hbc = 5;
    ...
    public static final int check_init_throw_analysis_hbc = 6;
        ...
        while(hasMoreOptions()) {
            ...
            if (false);
                ...
                whole_program = true;
                    ...
                    || option.equals("rn")
                    || option.equals("react-native")
            )
                react_native = true;
            else if (false
                    || option.equals("hbc-cf-sensitive")
                    || option.equals("hbc-control-flow-sensitive")
            )
                hbc_control_flow_sensitive = true;
            else if (false
                    || option.equals("ws")
                ...
                if (dotnet_nativehost_path.isEmpty())
                    ...
                    || option.equals("hbc-nativehost-path")
            ) {
                if (!hasMoreOptions()) {
                    G.v().out.println("No value given for option -" + option);
                    return false;
                ...
                String value = nextOption();
                if (hbc_nativehost_path.isEmpty())
                    hbc_nativehost_path = value;
                else {
                    G.v().out.println("Duplicate values " + hbc_nativehost_path + " and " + value + " for option -" + option);
                    return false;
                }
            }
            else if (false
                ...
                if (false);
                    ...
                    if (src_prec != 0 && src_prec != src_prec_hbc) {
                        G.v().out.println("Multiple values given for option " + option);
                        return false;
                    }
                    src_prec = src_prec_hbc;
                }
                else {
                ...
                resolve_all_dotnet_methods = false;
                    ...
                    || option.equals("no-resolve-all-hbc-methods")
            )
                resolve_all_hbc_methods = false;
            else if (false
                ...
                if (false);
                    ...
                    if (throw_analysis != 0 && throw_analysis != throw_analysis_hbc) {
                        G.v().out.println("Multiple values given for option " + option);
                        return false;
                    }
                    throw_analysis = throw_analysis_hbc;
                }
                else if (false
                ...
                if (false);
                    ...
                    if (check_init_throw_analysis != 0 && check_init_throw_analysis != check_init_throw_analysis_hbc) {
                        G.v().out.println("Multiple values given for option " + option);
                        return false;
                    }
                    check_init_throw_analysis = check_init_throw_analysis_hbc;
                }
                else {
                    G.v().out.println(String.format("Invalid value %s given for option -%s", value, option));
                    return false;
    ...
    public boolean react_native() { return react_native; }
    private boolean react_native = false;
    public void set_react_native(boolean setting) { react_native = setting; }

    public boolean hbc_control_flow_sensitive() { return hbc_control_flow_sensitive; }
    private boolean hbc_control_flow_sensitive = false;
    public void set_hbc_control_flow_sensitive(boolean setting) { hbc_control_flow_sensitive = setting; }
    ...
    public String hbc_nativehost_path() { return hbc_nativehost_path; }
    public void set_hbc_nativehost_path(String setting) { hbc_nativehost_path = setting; }
    private String hbc_nativehost_path = "";
    ...
    public boolean resolve_all_hbc_methods() { return resolve_all_hbc_methods; }
    private boolean resolve_all_hbc_methods = true;
    public void set_resolve_all_hbc_methods(boolean setting) { resolve_all_hbc_methods = setting; }
    ...
    public String getUsage() {
        return ""
                ...
                + padOpt("-rn, -react-native", "Run in react-native mode")
                + padOpt("-hbc-cf-sensitive, -hbc-control-flow-sensitive", "Run in hbc-control-flow-sensitive mode")
                ...
                + padOpt("-hbc-nativehost-path ARG", "Use  to locate your NativeHost hbctool.")
                ...
                + padOpt("-src-prec ARG", "Sets source precedence to ARG files")
                    ...
                    + padVal("hbc", "Favour HBC files as Soot source, disregard Java files")
                ...
                + padOpt("-resolve-all-hbc-methods", "Resolve all hbc methods, such as unsafe methods")
